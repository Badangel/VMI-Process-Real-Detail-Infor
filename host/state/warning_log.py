...
def warining_w(vmi,domname, pid, pname):
    ...
    file_warning = open('/home/vmi/Downloads/code/VmiXen/host/log/warning.log', 'a')
...
def printlog(s):
    file_warning = open('/home/vmi/Downloads/code/VmiXen/host/log/print.log', 'a')
    file_warning.write('['+str(time.ctime())+']'+s+'\n')
    file_warning.close()

def cprintlog(s):
    file_warning = open('/home/vmi/Downloads/code/VmiXen/host/log/cprint.log', 'a')
    file_warning.write('['+str(time.ctime())+']'+s+'\n')
    file_warning.close()