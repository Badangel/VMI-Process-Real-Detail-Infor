...
//        }
        ...
        while(n>0)
        {
            ...
            do
            {
                readn = read(fdpipe[0], buf, 5);
                printf("%d father read result is %s\n",readn, buf);
...
//    printf("cr0:%x",cr0);
       ...
       // scanf("%d",&a);
        ...
        while(n>0)
        {
            ...
            writen = write(fdpipe[1], "hi ", 5);
            printf("%d This is child, write reply to pipe\n",writen);
            writen = write(fdpipe[1], "bye", 5);
            printf("%d This is child, write2 reply to pipe\n",writen);
            //printf("child know father write\n");
        }
        printf("child exit\n");
    }
